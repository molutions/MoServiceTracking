namespace MoServiceTracking.Migrations
{
    ...
    public partial class AddCityTableAndSeedCitiesIntoDatabase : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PlateNum = c.Int(nullable: true),
                        CityTitle = c.String(maxLength:100,nullable:false),
                        CityDesc = c.String(maxLength:256),
                        Notes = c.String(),
                    })
                .PrimaryKey(t => t.Id)
